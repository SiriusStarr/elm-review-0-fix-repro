...
import NoUnsortedCasesTest
import NoUnsortedRecordsTest
import NoUnsortedTopLevelDeclarationsTest
import NoUnsortedLetDeclarationsTest
...
tests : List Test
tests =
    [ check NoUnsortedCasesTest.all
    , check NoUnsortedRecordsTest.all
    , check NoUnsortedTopLevelDeclarationsTest.all
    , check NoUnsortedLetDeclarationsTest.all ]
